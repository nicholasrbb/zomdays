...
public class InGameMenu extends JPanel{
	...
	GameFrame game;
		public InGameMenu(final GameFrame game){
			super();
			this.game = game;
			...
			Image image = Toolkit.getDefaultToolkit().createImage("ResumeGame.png");
			ImageIcon iconimage = new ImageIcon(image);
			Image image2 = Toolkit.getDefaultToolkit().createImage("Back.png");
